...
Author: ZloyLeva <zloyleva@gmail.com>
Contributor: ZloyLeva <zloyleva@gmail.com>
...
<div class="wrap">
	...
	<?php
	if(isset($_POST['rtl_standard']) && $_POST['rtl_standard']) {
...
function rtl_add_menu() {
		add_options_page('RusToLat', 'RusToLat',  'manage_options', __FILE__, 'rtl_options_page');
}
