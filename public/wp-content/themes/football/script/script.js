...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__header_header__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__content_left_sidebar__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__content_right_sidebar__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_who_is_your_bk__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__content_rate_your_bk__ = __webpack_require__(12);
...
$(document).ready(function () {
    console.log('Start...');
    new __WEBPACK_IMPORTED_MODULE_0__header_header__["a" /* HeaderModule */]();
    new __WEBPACK_IMPORTED_MODULE_1__content_left_sidebar__["a" /* LeftSidebarModule */]();
    new __WEBPACK_IMPORTED_MODULE_2__content_right_sidebar__["a" /* RightSidebarModule */]();
    new __WEBPACK_IMPORTED_MODULE_3__content_who_is_your_bk__["a" /* WhoIsYourBk */]();
    new __WEBPACK_IMPORTED_MODULE_4__content_rate_your_bk__["a" /* RateYourBk */]();
...
var HeaderModule = function () {
    ...
    _createClass(HeaderModule, [{
        ...
        key: 'clickHumburgerMenu',
        value: function clickHumburgerMenu() {
            var _this = this;

            $('.humberger_menu img').off('click').on('click', function (e) {
                e.preventDefault();
                console.log('clickHumburgerMenu');

                if ($('.menu_control').hasClass('show_menu')) {
                    _this.hideHumburgerMenu();
                } else {
                    _this.showHumburgerMenu();
                }
            });
        }
    }, {
        key: 'showHumburgerMenu',
        value: function showHumburgerMenu() {
        ...
        key: 'hideHumburgerMenu',
        value: function hideHumburgerMenu() {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LeftSidebarModule; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var LeftSidebarModule = function () {
    function LeftSidebarModule() {
        _classCallCheck(this, LeftSidebarModule);
    ...
    _createClass(LeftSidebarModule, [{
        key: 'init',
        value: function init() {
            $('#who_is_your_bk').editableSelect({ filter: false }).on('select.editable-select', function (e, el) {
                // el is the selected item "option"
                $('#bk_id').val(el.data('value'));
            });
        }
    }, {
        key: 'clickOpenMenuHandler',
        value: function clickOpenMenuHandler() {
            var _this = this;

            $('.has_submenu').off('click').on('click', function (e) {
                e.preventDefault();
                console.log('clickOpenMenu');

                _this.toglleMenuMethod(e.target);
            });
        }
    }, {
        key: 'toglleMenuMethod',
        value: function toglleMenuMethod(element) {
            $(element).closest('li').find('ul.sub_menu').toggle();
            $(element).toggleClass('opens_menu');
        }
    }, {
        key: 'clickPlusBKHadler',
        value: function clickPlusBKHadler() {
            var _this2 = this;

            $('.more_button_container').off('click').on('click', function (e) {
                e.preventDefault();
                var $button = $(e.target);
                ...
                if ($button.hasClass('close_bk_list')) {
                    ...
                    _this2.show_bk_list($button);
                } else {
                    console.log('open_bk_list');
                    $(e.target).removeClass('open_bk_list').addClass('close_bk_list');
                    _this2.hide_bk_list($button);
                }
            });
        }
    }, {
        key: 'show_bk_list',
        value: function show_bk_list(element) {
            $('ul.bk_list.left li.hide_item').show('slow');
            element.text('-');
        }
    }, {
        key: 'hide_bk_list',
        value: function hide_bk_list(element) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RightSidebarModule; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RightSidebarModule = function () {
    function RightSidebarModule() {
        _classCallCheck(this, RightSidebarModule);
    ...
    _createClass(RightSidebarModule, [{
        key: 'init',
        value: function init() {
            $('#select_bk').editableSelect({ filter: false }).on('select.editable-select', function (e, el) {
                // el is the selected item "option"
                $('#rate_bk_id').val(el.data('value'));
            });
        }
    }, {
        key: 'changeRangeHandler',
        value: function changeRangeHandler() {
            $('#bk_rate').change(function (e) {
                var $range = $(e.target);
        ...
        key: 'clickOpenBKListHandler',
        value: function clickOpenBKListHandler() {
            var _this = this;

            $('#show_bk_list').off('click').on('click', function (e) {
                e.preventDefault();
                var $button = $(e.target);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WhoIsYourBk; });
...
var WhoIsYourBk = function (_ApiModule) {
    _inherits(WhoIsYourBk, _ApiModule);

    function WhoIsYourBk() {
        _classCallCheck(this, WhoIsYourBk);

        var _this = _possibleConstructorReturn(this, (WhoIsYourBk.__proto__ || Object.getPrototypeOf(WhoIsYourBk)).call(this));

        console.log('WhoIsYourBk is load');

        _this.whoIsYourBkFormHandler();
        _this.checkForm();
        return _this;
    }

    _createClass(WhoIsYourBk, [{
        key: 'whoIsYourBkFormHandler',
        value: function whoIsYourBkFormHandler() {
            var _this2 = this;

            $('#who_is_your_bk_button').off('click').on('click', function (e) {
                e.preventDefault();

                console.log('whoIsYourBkFormHandler');
                if ($('#who_is_your_bk_form').valid()) {
                    console.log('valid');
                    _this2.sendFormMethod();
                }
            });
        }
    }, {
        key: 'sendFormMethod',
        value: function sendFormMethod() {
            var _this3 = this;
            ...
            this.post({
                ...
                success: function success(response) {
                    ...
                    if (response.status == true) {
                        _this3.renderBukmekerGraph(response.data);
                        _this3.renderBukmekerList(response.data);
                        _this3.renderBukmekerTotal(response.data);
                    }
                }
            });
        }
    }, {
        key: 'renderBukmekerGraph',
        value: function renderBukmekerGraph(data) {
            var html = '';
            var bukmekers_list = data.bukmekers_list;
            var total_subscriptions = data.total_subscriptions;
            var total_bukmekers = data.total_bukmekers;
            for (var i = 0; i < bukmekers_list.length; i++) {
                var bukmeker_item = bukmekers_list[i];
                var bukmekers_users_count = bukmeker_item.bukmekers_users_count > 0 ? bukmeker_item.bukmekers_users_count : 1;
        ...
        key: 'renderBukmekerList',
        value: function renderBukmekerList(data) {
            var html = '';
            var bukmekers_list = data.bukmekers_list;
            var total_subscriptions = data.total_subscriptions;
            for (var i = 0; i < bukmekers_list.length; i++) {
                var bukmeker_item = bukmekers_list[i];
                var bukmekers_users_count = bukmeker_item['bukmekers_users_count'];
                var percents = bukmekers_users_count > 0 ? (100 * bukmekers_users_count / total_subscriptions).toFixed(1) : 0;
        ...
        key: 'renderBukmekerTotal',
        value: function renderBukmekerTotal(data) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RateYourBk; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api__ = __webpack_require__(1);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RateYourBk = function (_ApiModule) {
    _inherits(RateYourBk, _ApiModule);

    function RateYourBk() {
        _classCallCheck(this, RateYourBk);

        var _this = _possibleConstructorReturn(this, (RateYourBk.__proto__ || Object.getPrototypeOf(RateYourBk)).call(this));

        console.log('RateYourBk is load');

        _this.RateYourBkFormHandler();
        // this.checkForm();
        return _this;
    }

    _createClass(RateYourBk, [{
        key: 'RateYourBkFormHandler',
        value: function RateYourBkFormHandler() {
            var _this2 = this;

            $('#rate_bk_button').off('click').on('click', function (e) {
                e.preventDefault();
